...
.method public static i(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0, p1}, Lkotlin/collections/m0;->a(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static varargs j([Lkotlin/q;)Ljava/util/HashMap;
    .locals 2
    .param p0    # [Lkotlin/q;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-static {v0, p0}, Lkotlin/collections/o0;->q(Ljava/util/Map;[Lkotlin/q;)V

    return-object v0
.end method

.method public static varargs k([Lkotlin/q;)Ljava/util/Map;
    .locals 2
    .param p0    # [Lkotlin/q;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-static {p0, v0}, Lkotlin/collections/o0;->u([Lkotlin/q;Ljava/util/Map;)Ljava/util/Map;
...
.method public static varargs l([Lkotlin/q;)Ljava/util/Map;
    .locals 2
    .param p0    # [Lkotlin/q;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public static final m(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 2
    :cond_0
    invoke-static {p0}, Lkotlin/collections/n0;->f(Ljava/util/Map;)Ljava/util/Map;
...
.method public static o(Ljava/util/Map;Lkotlin/q;)Ljava/util/Map;
    .locals 1
    .param p0    # Ljava/util/Map;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public static final q(Ljava/util/Map;[Lkotlin/q;)V
    .locals 4
    .param p0    # Ljava/util/Map;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
...
.method public static r(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lkotlin/collections/o0;->s(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/o0;->s(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0}, Lkotlin/collections/o0;->m(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final s(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1, p0}, Lkotlin/collections/o0;->p(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static final u([Lkotlin/q;Ljava/util/Map;)Ljava/util/Map;
    .locals 1
    .param p0    # [Lkotlin/q;
        .annotation build Lorg/jetbrains/annotations/NotNull;
        .end annotation
    ...
    invoke-static {p1, p0}, Lkotlin/collections/o0;->q(Ljava/util/Map;[Lkotlin/q;)V
