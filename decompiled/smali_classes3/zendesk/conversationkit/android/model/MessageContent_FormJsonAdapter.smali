.class public final Lzendesk/conversationkit/android/model/MessageContent_FormJsonAdapter;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lzendesk/conversationkit/android/model/MessageContent_FormJsonAdapter;",
        "Lcom/squareup/moshi/h;",
        "Lzendesk/conversationkit/android/model/MessageContent$Form;",
        "",
        "toString",
...
.method public constructor <init>(Lcom/squareup/moshi/t;)V
    ...
    const-string v2, "blockChatInput"
    ...
    iput-object v3, p0, Lzendesk/conversationkit/android/model/MessageContent_FormJsonAdapter;->a:Lcom/squareup/moshi/k$a;
    ...
    iput-object v0, p0, Lzendesk/conversationkit/android/model/MessageContent_FormJsonAdapter;->b:Lcom/squareup/moshi/h;
    ...
    const-class v5, Lzendesk/conversationkit/android/model/Field;

    aput-object v5, v3, v4

    invoke-static {v0, v3}, Lcom/squareup/moshi/x;->j(Ljava/lang/reflect/Type;[Ljava/lang/reflect/Type;)Ljava/lang/reflect/ParameterizedType;
    ...
    iput-object v0, p0, Lzendesk/conversationkit/android/model/MessageContent_FormJsonAdapter;->c:Lcom/squareup/moshi/h;
    ...
    iput-object p1, p0, Lzendesk/conversationkit/android/model/MessageContent_FormJsonAdapter;->d:Lcom/squareup/moshi/h;
...
# virtual methods
.method public a(Lcom/squareup/moshi/k;)Lzendesk/conversationkit/android/model/MessageContent$Form;
    .locals 8
    ...
    .line 3
    iget-object v3, p0, Lzendesk/conversationkit/android/model/MessageContent_FormJsonAdapter;->a:Lcom/squareup/moshi/k$a;
    ...
    .line 4
    :cond_0
    iget-object v2, p0, Lzendesk/conversationkit/android/model/MessageContent_FormJsonAdapter;->d:Lcom/squareup/moshi/h;
    ...
    const-string p1, "unexpectedNull(\"blockCha\u2026\"blockChatInput\", reader)"
    ...
    .line 6
    :cond_2
    iget-object v1, p0, Lzendesk/conversationkit/android/model/MessageContent_FormJsonAdapter;->c:Lcom/squareup/moshi/h;
    ...
    .line 7
    :cond_4
    iget-object v0, p0, Lzendesk/conversationkit/android/model/MessageContent_FormJsonAdapter;->b:Lcom/squareup/moshi/h;
    ...
    .line 11
    new-instance p0, Lzendesk/conversationkit/android/model/MessageContent$Form;
    ...
    .line 13
    invoke-direct {p0, v0, v1, p1}, Lzendesk/conversationkit/android/model/MessageContent$Form;-><init>(Ljava/lang/String;Ljava/util/List;Z)V
    ...
    const-string p1, "missingProperty(\"blockCh\u2026\"blockChatInput\", reader)"
    ...
    const-string p1, "missingProperty(\"fields\", \"fields\", reader)"
    ...
    const-string p1, "missingProperty(\"formId\", \"formId\", reader)"
...
.method public b(Lcom/squareup/moshi/q;Lzendesk/conversationkit/android/model/MessageContent$Form;)V
    .locals 2
    ...
    invoke-virtual {p2}, Lzendesk/conversationkit/android/model/MessageContent$Form;->d()Ljava/lang/String;
    ...
    .line 6
    iget-object v0, p0, Lzendesk/conversationkit/android/model/MessageContent_FormJsonAdapter;->c:Lcom/squareup/moshi/h;

    invoke-virtual {p2}, Lzendesk/conversationkit/android/model/MessageContent$Form;->c()Ljava/util/List;
    ...
    .line 8
    iget-object p0, p0, Lzendesk/conversationkit/android/model/MessageContent_FormJsonAdapter;->d:Lcom/squareup/moshi/h;

    invoke-virtual {p2}, Lzendesk/conversationkit/android/model/MessageContent$Form;->b()Z
...
.method public bridge synthetic fromJson(Lcom/squareup/moshi/k;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lzendesk/conversationkit/android/model/MessageContent_FormJsonAdapter;->a(Lcom/squareup/moshi/k;)Lzendesk/conversationkit/android/model/MessageContent$Form;
...
.method public bridge synthetic toJson(Lcom/squareup/moshi/q;Ljava/lang/Object;)V
    ...
    check-cast p2, Lzendesk/conversationkit/android/model/MessageContent$Form;

    invoke-virtual {p0, p1, p2}, Lzendesk/conversationkit/android/model/MessageContent_FormJsonAdapter;->b(Lcom/squareup/moshi/q;Lzendesk/conversationkit/android/model/MessageContent$Form;)V
...
.method public toString()Ljava/lang/String;
    ...
    const-string v1, "MessageContent.Form"
