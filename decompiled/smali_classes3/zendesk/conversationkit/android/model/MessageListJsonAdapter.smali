.class public final Lzendesk/conversationkit/android/model/MessageListJsonAdapter;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lzendesk/conversationkit/android/model/MessageListJsonAdapter;",
        "Lcom/squareup/moshi/h;",
        "Lzendesk/conversationkit/android/model/MessageList;",
        "",
        "toString",
...
.method public constructor <init>(Lcom/squareup/moshi/t;)V
    ...
    iput-object v2, p0, Lzendesk/conversationkit/android/model/MessageListJsonAdapter;->a:Lcom/squareup/moshi/k$a;
    ...
    const-class v5, Lzendesk/conversationkit/android/model/Message;
    ...
    iput-object v0, p0, Lzendesk/conversationkit/android/model/MessageListJsonAdapter;->b:Lcom/squareup/moshi/h;
    ...
    iput-object p1, p0, Lzendesk/conversationkit/android/model/MessageListJsonAdapter;->c:Lcom/squareup/moshi/h;
...
# virtual methods
.method public a(Lcom/squareup/moshi/k;)Lzendesk/conversationkit/android/model/MessageList;
    .locals 6
    ...
    .line 3
    iget-object v3, p0, Lzendesk/conversationkit/android/model/MessageListJsonAdapter;->a:Lcom/squareup/moshi/k$a;
    ...
    .line 4
    :cond_0
    iget-object v2, p0, Lzendesk/conversationkit/android/model/MessageListJsonAdapter;->c:Lcom/squareup/moshi/h;
    ...
    .line 5
    :cond_1
    iget-object v1, p0, Lzendesk/conversationkit/android/model/MessageListJsonAdapter;->c:Lcom/squareup/moshi/h;
    ...
    .line 6
    :cond_2
    iget-object v0, p0, Lzendesk/conversationkit/android/model/MessageListJsonAdapter;->b:Lcom/squareup/moshi/h;
    ...
    .line 11
    new-instance p0, Lzendesk/conversationkit/android/model/MessageList;

    if-eqz v0, :cond_6

    invoke-direct {p0, v0, v1, v2}, Lzendesk/conversationkit/android/model/MessageList;-><init>(Ljava/util/List;Ljava/lang/Boolean;Ljava/lang/Boolean;)V
...
.method public b(Lcom/squareup/moshi/q;Lzendesk/conversationkit/android/model/MessageList;)V
    .locals 2
    ...
    invoke-virtual {p2}, Lzendesk/conversationkit/android/model/MessageList;->c()Ljava/util/List;
    ...
    .line 6
    iget-object v0, p0, Lzendesk/conversationkit/android/model/MessageListJsonAdapter;->c:Lcom/squareup/moshi/h;

    invoke-virtual {p2}, Lzendesk/conversationkit/android/model/MessageList;->b()Ljava/lang/Boolean;
    ...
    .line 8
    iget-object p0, p0, Lzendesk/conversationkit/android/model/MessageListJsonAdapter;->c:Lcom/squareup/moshi/h;

    invoke-virtual {p2}, Lzendesk/conversationkit/android/model/MessageList;->a()Ljava/lang/Boolean;
...
.method public bridge synthetic fromJson(Lcom/squareup/moshi/k;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lzendesk/conversationkit/android/model/MessageListJsonAdapter;->a(Lcom/squareup/moshi/k;)Lzendesk/conversationkit/android/model/MessageList;
...
.method public bridge synthetic toJson(Lcom/squareup/moshi/q;Ljava/lang/Object;)V
    ...
    check-cast p2, Lzendesk/conversationkit/android/model/MessageList;

    invoke-virtual {p0, p1, p2}, Lzendesk/conversationkit/android/model/MessageListJsonAdapter;->b(Lcom/squareup/moshi/q;Lzendesk/conversationkit/android/model/MessageList;)V
