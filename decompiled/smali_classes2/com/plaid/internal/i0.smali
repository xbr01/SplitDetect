...
.field public j:Lcom/plaid/internal/core/protos/link/workflow/nodes/panes/ButtonListPaneOuterClass$ButtonListPane$Rendering$Events;
...
.method public constructor <init>(Lcom/plaid/internal/lh;Lcom/plaid/internal/xa;)V
    ...
    iput-object v0, p0, Lcom/plaid/internal/i0;->h:Lkotlinx/coroutines/flow/s;

    .line 3
    invoke-interface {p2}, Lcom/plaid/internal/xa;->m()Lcom/plaid/internal/f0$a;

    move-result-object p2

    check-cast p2, Lcom/plaid/internal/j4$d;

    invoke-virtual {p2}, Lcom/plaid/internal/j4$d;->a()Ljava/lang/Object;

    move-result-object p2

    check-cast p2, Lcom/plaid/internal/f0;
    ...
    new-instance v6, Lcom/plaid/internal/i0$a;

    invoke-direct {v6, p0, p1, v2}, Lcom/plaid/internal/i0$a;-><init>(Lcom/plaid/internal/i0;Lcom/plaid/internal/lh;Lkotlin/coroutines/d;)V
...
.method public a()V
    ...
    .line 2
    sget-object v0, Lcom/plaid/internal/i0$b;->g:Lcom/plaid/internal/core/protos/link/workflow/nodes/panes/ButtonListPaneOuterClass$ButtonListPane$Actions$b;

    const/4 v1, 0x0

    .line 3
    invoke-virtual {p0, v0, v1}, Lcom/plaid/internal/i0;->a(Lcom/plaid/internal/core/protos/link/workflow/nodes/panes/ButtonListPaneOuterClass$ButtonListPane$Actions$b;Lcom/plaid/internal/core/protos/link/workflow/nodes/panes/Common$SDKEvent;)V

    return-void
.end method

.method public final a(Lcom/plaid/internal/core/protos/link/workflow/nodes/panes/ButtonListPaneOuterClass$ButtonListPane$Actions$b;Lcom/plaid/internal/core/protos/link/workflow/nodes/panes/Common$SDKEvent;)V
    .locals 2

    .line 4
    iget-object v0, p0, Lcom/plaid/internal/i0;->i:Lcom/plaid/internal/core/protos/link/workflow/nodes/panes/Pane$PaneRendering;
    ...
    invoke-virtual {v1, p1}, Lcom/plaid/internal/core/protos/link/workflow/nodes/panes/Pane$PaneOutput$a;->a(Lcom/plaid/internal/core/protos/link/workflow/nodes/panes/ButtonListPaneOuterClass$ButtonListPane$Actions$b;)Lcom/plaid/internal/core/protos/link/workflow/nodes/panes/Pane$PaneOutput$a;

    move-result-object p1

    const-string v1, "newBuilder().setButtonList(action)"
