...
.field private static final sLocalNightModes:Landroidx/collection/g;
...
.field mFadeAnim:Landroidx/core/view/f0;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/app/AppCompatDelegateImpl;->sLocalNightModes:Landroidx/collection/g;
...
.method private constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroidx/appcompat/app/AppCompatCallback;Ljava/lang/Object;)V
    ...
    .line 6
    iput-object v0, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mFadeAnim:Landroidx/core/view/f0;
    ...
    .line 17
    sget-object p1, Landroidx/appcompat/app/AppCompatDelegateImpl;->sLocalNightModes:Landroidx/collection/g;
...
.method private applyApplicationSpecificConfig(ZZ)Z
    ...
    invoke-virtual {p0, v2}, Landroidx/appcompat/app/AppCompatDelegateImpl;->calculateApplicationLocales(Landroid/content/Context;)Landroidx/core/os/h;
    ...
    .line 10
    invoke-virtual {p0, p2}, Landroidx/appcompat/app/AppCompatDelegateImpl;->getConfigurationLocales(Landroid/content/res/Configuration;)Landroidx/core/os/h;

    move-result-object v2

    .line 11
    :cond_2
    invoke-direct {p0, v1, v2, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->updateAppConfiguration(ILandroidx/core/os/h;Z)Z
...
.method private createOverrideAppConfiguration(Landroid/content/Context;ILandroidx/core/os/h;Landroid/content/res/Configuration;Z)Landroid/content/res/Configuration;
    .locals 1
    ...
    .line 7
    invoke-virtual {p0, p2, p3}, Landroidx/appcompat/app/AppCompatDelegateImpl;->setConfigurationLocales(Landroid/content/res/Configuration;Landroidx/core/os/h;)V
...
.method private createSubDecor()Landroid/view/ViewGroup;
    ...
    invoke-static {v0, v1}, Landroidx/core/view/z;->B0(Landroid/view/View;Landroidx/core/view/u;)V
...
.method private updateActivityConfiguration(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {p0, v1}, Landroidx/lifecycle/j$b;->d(Landroidx/lifecycle/j$b;)Z
...
.method private updateAppConfiguration(ILandroidx/core/os/h;Z)Z
    .locals 8
    ...
    .line 2
    invoke-direct/range {v0 .. v5}, Landroidx/appcompat/app/AppCompatDelegateImpl;->createOverrideAppConfiguration(Landroid/content/Context;ILandroidx/core/os/h;Landroid/content/res/Configuration;Z)Landroid/content/res/Configuration;
    ...
    .line 8
    invoke-virtual {p0, v2}, Landroidx/appcompat/app/AppCompatDelegateImpl;->getConfigurationLocales(Landroid/content/res/Configuration;)Landroidx/core/os/h;
    ...
    .line 9
    :cond_1
    invoke-virtual {p0, v0}, Landroidx/appcompat/app/AppCompatDelegateImpl;->getConfigurationLocales(Landroid/content/res/Configuration;)Landroidx/core/os/h;
    ...
    invoke-static {p3}, Landroidx/core/app/a;->t(Landroid/app/Activity;)V
    ...
    .line 14
    :cond_6
    invoke-direct {p0, v4, v0, v6, v5}, Landroidx/appcompat/app/AppCompatDelegateImpl;->updateResourcesConfiguration(ILandroidx/core/os/h;ZLandroid/content/res/Configuration;)V
    ...
    .line 20
    invoke-virtual {p0, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->getConfigurationLocales(Landroid/content/res/Configuration;)Landroidx/core/os/h;

    move-result-object p1

    invoke-virtual {p0, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->setDefaultLocalesForLocaleList(Landroidx/core/os/h;)V

    :cond_a
    return v7
.end method

.method private updateResourcesConfiguration(ILandroidx/core/os/h;ZLandroid/content/res/Configuration;)V
    .locals 3
    ...
    .line 5
    invoke-virtual {p0, v1, p2}, Landroidx/appcompat/app/AppCompatDelegateImpl;->setConfigurationLocales(Landroid/content/res/Configuration;Landroidx/core/os/h;)V
...
.method private updateStatusGuardColor(Landroid/view/View;)V
    ...
    .line 1
    invoke-static {p1}, Landroidx/core/view/z;->J(Landroid/view/View;)I
...
.method applyAppLocales()Z
    ...
    .line 2
    invoke-static {}, Landroidx/appcompat/app/AppCompatDelegate;->getRequestedAppLocales()Landroidx/core/os/h;
    ...
    invoke-static {}, Landroidx/appcompat/app/AppCompatDelegate;->getStoredAppLocales()Landroidx/core/os/h;

    move-result-object v1

    invoke-virtual {v0, v1}, Landroidx/core/os/h;->equals(Ljava/lang/Object;)Z
...
.method public attachBaseContext2(Landroid/content/Context;)Landroid/content/Context;
    ...
    .line 5
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/appcompat/app/AppCompatDelegateImpl;->calculateApplicationLocales(Landroid/content/Context;)Landroidx/core/os/h;
    ...
    .line 7
    invoke-direct/range {v2 .. v7}, Landroidx/appcompat/app/AppCompatDelegateImpl;->createOverrideAppConfiguration(Landroid/content/Context;ILandroidx/core/os/h;Landroid/content/res/Configuration;Z)Landroid/content/res/Configuration;
...
.method calculateApplicationLocales(Landroid/content/Context;)Landroidx/core/os/h;
    .locals 3
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    .line 6
    invoke-static {v0, p0}, Landroidx/appcompat/app/LocaleOverlayHelper;->combineLocalesIfOverlayExists(Landroidx/core/os/h;Landroidx/core/os/h;)Landroidx/core/os/h;

    move-result-object p1

    .line 7
    invoke-virtual {p1}, Landroidx/core/os/h;->e()Z
...
.method endOnGoingFadeAnimation()V
    ...
    .line 1
    iget-object p0, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mFadeAnim:Landroidx/core/view/f0;
...
.method getConfigurationLocales(Landroid/content/res/Configuration;)Landroidx/core/os/h;
    .locals 0

    invoke-static {p1}, Landroidx/appcompat/app/AppCompatDelegateImpl$Api24Impl;->getLocales(Landroid/content/res/Configuration;)Landroidx/core/os/h;
...
.method public onDestroy()V
    ...
    .line 8
    sget-object v0, Landroidx/appcompat/app/AppCompatDelegateImpl;->sLocalNightModes:Landroidx/collection/g;
...
.method setConfigurationLocales(Landroid/content/res/Configuration;Landroidx/core/os/h;)V
    .locals 0
    ...
    invoke-static {p1, p2}, Landroidx/appcompat/app/AppCompatDelegateImpl$Api24Impl;->setLocales(Landroid/content/res/Configuration;Landroidx/core/os/h;)V
...
.method setDefaultLocalesForLocaleList(Landroidx/core/os/h;)V
    .locals 0

    invoke-static {p1}, Landroidx/appcompat/app/AppCompatDelegateImpl$Api24Impl;->setDefaultLocales(Landroidx/core/os/h;)V
...
.method startSupportActionModeFromWindow(Landroidx/appcompat/view/ActionMode$Callback;)Landroidx/appcompat/view/ActionMode;
    ...
    invoke-static {p1}, Landroidx/core/view/z;->d(Landroid/view/View;)Landroidx/core/view/f0;
    ...
    iput-object p1, p0, Landroidx/appcompat/app/AppCompatDelegateImpl;->mFadeAnim:Landroidx/core/view/f0;
    ...
    invoke-static {p1}, Landroidx/core/view/z;->j0(Landroid/view/View;)V
...
.method final updateStatusGuard(Landroidx/core/view/l0;Landroid/graphics/Rect;)I
    .locals 10
    ...
    .line 17
    invoke-virtual {p1}, Landroidx/core/view/l0;->i()I
    ...
    invoke-static {v6}, Landroidx/core/view/z;->E(Landroid/view/View;)Landroidx/core/view/l0;
    ...
    .line 24
    :cond_4
    invoke-virtual {v6}, Landroidx/core/view/l0;->j()I
