...
.method public static a(Landroid/graphics/Rect;ZLandroid/util/Rational;IIILjava/util/Map;)Ljava/util/Map;
    ...
    check-cast p6, Landroidx/camera/core/d3;
    ...
    .line 16
    invoke-static/range {v2 .. v7}, Landroidx/camera/core/internal/k;->g(Landroid/graphics/RectF;Landroid/util/Rational;IZII)Landroid/graphics/RectF;
    ...
    check-cast p5, Landroidx/camera/core/d3;
...
.method private static b(ZILandroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
    ...
    invoke-static {p3, p0}, Landroidx/camera/core/internal/k;->d(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    .line 4
    invoke-static {p0, p1}, Landroidx/camera/core/internal/k;->c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    invoke-static {p3, p0}, Landroidx/camera/core/internal/k;->c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
...
.method private static c(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    .line 2
    invoke-static {v1, p1}, Landroidx/camera/core/internal/k;->e(FF)F
    ...
    .line 3
    invoke-static {v3, p1}, Landroidx/camera/core/internal/k;->e(FF)F
...
.method private static d(Landroid/graphics/RectF;F)Landroid/graphics/RectF;
    ...
    .line 2
    invoke-static {v2, p1}, Landroidx/camera/core/internal/k;->f(FF)F
    ...
    .line 3
    invoke-static {p0, p1}, Landroidx/camera/core/internal/k;->f(FF)F
...
.method public static g(Landroid/graphics/RectF;Landroid/util/Rational;IZII)Landroid/graphics/RectF;
    ...
    .line 10
    invoke-static {p3, p4}, Landroidx/camera/core/internal/k;->h(ZI)Z

    move-result p2

    .line 11
    invoke-static {p2, p5, p0, p1}, Landroidx/camera/core/internal/k;->b(ZILandroid/graphics/RectF;Landroid/graphics/RectF;)Landroid/graphics/RectF;
