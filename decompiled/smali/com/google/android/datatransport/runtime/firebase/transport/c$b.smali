...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v3, v4, v4}, Lcom/google/android/datatransport/runtime/firebase/transport/c$b;-><init>(Ljava/lang/String;II)V
    ...
    invoke-direct {v3, v5, v6, v6}, Lcom/google/android/datatransport/runtime/firebase/transport/c$b;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/google/android/datatransport/runtime/firebase/transport/c$b;->CACHE_FULL:Lcom/google/android/datatransport/runtime/firebase/transport/c$b;
    ...
    invoke-direct {v5, v7, v8, v8}, Lcom/google/android/datatransport/runtime/firebase/transport/c$b;-><init>(Ljava/lang/String;II)V

    sput-object v5, Lcom/google/android/datatransport/runtime/firebase/transport/c$b;->PAYLOAD_TOO_BIG:Lcom/google/android/datatransport/runtime/firebase/transport/c$b;

    .line 5
    new-instance v7, Lcom/google/android/datatransport/runtime/firebase/transport/c$b;

    const-string v9, "MAX_RETRIES_REACHED"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10, v10}, Lcom/google/android/datatransport/runtime/firebase/transport/c$b;-><init>(Ljava/lang/String;II)V

    sput-object v7, Lcom/google/android/datatransport/runtime/firebase/transport/c$b;->MAX_RETRIES_REACHED:Lcom/google/android/datatransport/runtime/firebase/transport/c$b;

    .line 6
    new-instance v9, Lcom/google/android/datatransport/runtime/firebase/transport/c$b;

    const-string v11, "INVALID_PAYLOD"

    const/4 v12, 0x5

    invoke-direct {v9, v11, v12, v12}, Lcom/google/android/datatransport/runtime/firebase/transport/c$b;-><init>(Ljava/lang/String;II)V

    sput-object v9, Lcom/google/android/datatransport/runtime/firebase/transport/c$b;->INVALID_PAYLOD:Lcom/google/android/datatransport/runtime/firebase/transport/c$b;

    .line 7
    new-instance v11, Lcom/google/android/datatransport/runtime/firebase/transport/c$b;

    const-string v13, "SERVER_ERROR"

    const/4 v14, 0x6

    invoke-direct {v11, v13, v14, v14}, Lcom/google/android/datatransport/runtime/firebase/transport/c$b;-><init>(Ljava/lang/String;II)V

    sput-object v11, Lcom/google/android/datatransport/runtime/firebase/transport/c$b;->SERVER_ERROR:Lcom/google/android/datatransport/runtime/firebase/transport/c$b;

    const/4 v13, 0x7

    new-array v13, v13, [Lcom/google/android/datatransport/runtime/firebase/transport/c$b;
    ...
    .line 8
    sput-object v13, Lcom/google/android/datatransport/runtime/firebase/transport/c$b;->$VALUES:[Lcom/google/android/datatransport/runtime/firebase/transport/c$b;
...
.method public getNumber()I
    ...
    iget p0, p0, Lcom/google/android/datatransport/runtime/firebase/transport/c$b;->number_:I
